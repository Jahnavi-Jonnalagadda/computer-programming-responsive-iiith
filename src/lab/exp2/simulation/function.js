window.view = {
	...
	validaterightangleTriangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a rightangleTriangle requires the length of the two sides of the rightangleTriangle. Try again.')
		else if ( b !== 'float' )
	...
	displayFunctionForrightangleTriangle: function() {
		document.getElementById('functionrightangleTriangle').innerHTML += 'float area_rightangleTriangle (float a,float b)<br>{<br> &emsp; float area = 0.5*a*b;<br> &emsp; return area;<br>}'
	},
